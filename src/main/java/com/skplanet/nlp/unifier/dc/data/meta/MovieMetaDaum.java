 ...
 * @date 3/17/15
 */
public class MovieMetaDaum extends AbsMeta {
    private static final Logger LOGGER = Logger.getLogger(MovieMetaDaum.class.getName());
     ...
     */
    public MovieMetaDaum(final Config item) {
        super(item);
    }
