 ...
 * @date 3/17/15
 */
public class DramaDomesticMetaHoppin extends AbsMeta {
    private static final Logger LOGGER = Logger.getLogger(DramaDomesticMetaHoppin.class.getName());
     ...
     */
    public DramaDomesticMetaHoppin(final Config item) {
        super(item);
    }
