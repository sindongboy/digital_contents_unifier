 ...
 * @date 3/17/15
 */
public class DramaForeignMetaTstore extends AbsMeta {
    private static final Logger LOGGER = Logger.getLogger(DramaForeignMetaTstore.class.getName());
     ...
     */
    public DramaForeignMetaTstore(final Config item) {
        super(item);
    }
