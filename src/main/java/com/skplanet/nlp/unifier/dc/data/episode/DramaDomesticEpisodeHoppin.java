 ...
 * @date 3/18/15
 */
public class DramaDomesticEpisodeHoppin extends AbsEpisode {
    private static final Logger LOGGER = Logger.getLogger(DramaDomesticEpisodeHoppin.class.getName());
     ...
     */
    public DramaDomesticEpisodeHoppin(final Config item) {
