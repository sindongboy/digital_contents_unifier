 ...
 * @date 3/17/15
 */
public class MovieMetaSKB extends AbsMeta {
    private static final Logger LOGGER = Logger.getLogger(MovieMetaSKB.class.getName());
     ...
     */
    public MovieMetaSKB(final Config item) {
        super(item);
    }
