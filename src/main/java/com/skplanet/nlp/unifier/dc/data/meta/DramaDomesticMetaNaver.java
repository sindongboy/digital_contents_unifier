 ...
 * @date 3/17/15
 */
public class DramaDomesticMetaNaver extends AbsMeta {
    private static final Logger LOGGER = Logger.getLogger(DramaDomesticMetaNaver.class.getName());
     ...
     */
    public DramaDomesticMetaNaver(final Config item) {
        super(item);
    }
