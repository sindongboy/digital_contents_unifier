...
# Target
#TARGET="../target/digital-contents-unifier-1.0.0-SNAPSHOT.jar"
...
java -Xmx4G -cp ${CP} com.skplanet.nlp.unifier.dc.driver.CrawlDataSplitter -c ${category} -v ${version} -o ${output}
